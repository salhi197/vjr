            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="avatar"><span>Irene Collins</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="avatar"><span>Andy King</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="avatar"><span>Laurie Fox</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="avatar"><span>Luke Ivory</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="avatar"><span>Ryan Collins</span></div>
                            </td>
                            <td>
            ...
            <div class="table-responsive">
                <table class="table table-scroll">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="td-content product-name"><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="product">
    ...
    <div class="widget widget-account-invoice-three">
        ...
        <div class="widget-heading">
            <div class="wallet-usr-info">
                <div class="usr-name">
                    <span><img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="admin-profile" class="img-fluid"> Alan Green</span>
                </div>
                <div class="add">
