								...
								<div class="row">
									<div class="col-xl-3 col-lg-6 col-sm-6 border-right">
										<div class="card-body text-center">
											...
											<h2 class="mb-1 mt-3  display-4 font-weight-semibold text-dark">{{Auth::user()->solde_actif}} $</h2>
									...
									<div class="col-xl-3 col-lg-6 col-sm-6 border-right">
										<div class="card-body text-center">
											...
											<h2 class="mb-1 mt-3  display-4 font-weight-semibold text-dark"> {{$benefice_total ?? ''}} $ <br><h2> <h6 class="mb-3">Benefice Total De Groupe </h6> <br> <h2>{{$benefice_total_groupe ?? 0}} $  </h2>
											<p class="mb-3 text-muted"> </p>
										</div>
									</div>
									...
									<div class="col-xl-3 col-lg-6  col-sm-6 border-right">
										<div class="card-body text-center">
											...
											<h2 class="mb-1 mt-3  display-4 font-weight-semibold text-dark">{{Auth::user()->solde}} $  </h2>
										</div>
									</div>
						...
						<div class="col-xl-6 col-md-12 col-lg-6">
							<div class="card">
								...
								<div class="card-body" width="200" height="250">									
									...
									<div class="chart-circle chart-circle-md" data-value="{{Auth::user()->pourcentage()/100}}" data-thickness="10" data-color="#04cad0">
										<div class="chart-circle-value text-center ">
											<h6 class="mb-0"><i class="fa fa-tasks" style="font-size:20px;"></i></h6>
										</div>
									</div>
									<h2 class="text-center mb-1 mt-3  display-4 font-weight-semibold text-dark">{{Auth::user()->pourcentage()}}%</h2>
