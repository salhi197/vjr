...
<head>
    ...
    <link href="{{asset('vjr/assets/css/authentication/form-1.css')}}" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{asset('vjr/assets/css/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vjr/assets/css/forms/switches.css')}}">
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
						...
						<form class="text-left" method="POST" action="{{route('login.admin')}}" aria-label="Login">
                            <div class="form">
    ...
    <script src="{{asset('vjr/assets/js/authentication/form-1.js')}}"></script>
