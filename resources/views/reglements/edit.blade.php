            ...
            <div class="card-body">
                    <form class="login100-form validate-form" method="POST" action="{{route('reglement.store')}}">
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                <label>Titre *</label>
                                <input type="text" class="form-control" value="{{$reglement->titre ?? ''}}" name="titre" id="titre" placeholder="loi..." required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Date *</label>
                                <input type="date" class="form-control" value="{{$reglement->ladate ?? ''}}" name="ladate" id="date" placeholder="Password" required>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label>Type de texte *</label>
                            <select id="selectpicker" value="{{$reglement->type ?? ''}}" name="type" class="form-control" data-live-search="true" required> 
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" value="{{$reglement->secteur ?? ''}}" name="secteur" class="form-control" data-live-search="true"> 
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" value="{{$reglement->organisme ?? ''}}" name="organisme" class="form-control" data-live-search="true"> 
                                    <option selected>Choisir...</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" value="{{$reglement->sous_organisme ?? ''}}" name="sous_organisme" class="form-control" data-live-search="true"> 
                                    <option selected>Choisir...</option>
                        ...
                        <div class="form-group mb-4">
                            <label>Contenu</label>
                            <textarea class="form-control" value="{{$reglement->contenu ?? ''}}" name="contenu"></textarea>
                        </div>
