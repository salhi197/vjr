    ...
    <div class="widget widget-one">
        ...
        <div class="w-chart">
            ...
            <div class="w-chart-section total-visits-content">
                <div class="w-detail">
                    <p class="w-title">Utilisateurs</p>
...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
    <div class="widget widget-card-four">
        <div class="widget-content">
            <div class="w-header">
                <div class="w-info">
                    <h6 class="value">Total des Recherches</h6>
                </div>
                <div class="task-action">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"
                            ...
                            <a class="dropdown-item" href="javascript:void(0);">Ce
                                Jour</a>
                            <a class="dropdown-item"
                                href="javascript:void(0);">Cette Semaine</a>
                            <a class="dropdown-item" href="javascript:void(0);">Ce
                                mois</a>
                        </div>
                    </div>
            ...
            <div class="w-content">
                ...
                <div class="w-info">
                    <p class="value"> 45,141 <span>ce mois</span> <svg
            ...
            <div class="w-progress-stats">
                <div class="progress">
                    <div class="progress-bar bg-gradient-secondary"
                        role="progressbar" style="width: 67%" aria-valuenow="57"
    ...
    <div class="widget widget-account-invoice-two">
        <div class="widget-content">
            <div class="account-box">
                <div class="info">
                    <div class="inv-title">
                        <h5 class="">Réglements</h5>
                    </div>
                    <div class="inv-balance-info">

                        <p class="inv-balance"> 41,741</p>
        ...
        <div class="widget-content">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <p class="meta-date-time">Lundi, Nov 18</p>
                </div>
            </div>
            ...
            <div class="w-action">
                <div class="card-like">
                    ...
                    <span>551 Commentaires</span>
                </div>

                <div class="read-more">
                    <a href="javascript:void(0);">Lire plus <svg
                            xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
    <div class="widget widget-chart-three">
        <div class="widget-heading">
            <div class="">
                <h5 class="">Visiteurs</h5>
            </div>

            <div class="dropdown ">
                <a class="dropdown-toggle" href="#" role="button"
                    id="uniqueVisitors" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2" stroke-linecap="round"
                ...
                <div class="timeline-line">
                        ...
                        <div class="t-content">
                            <div class="t-uppercontent">
                                <h5>New project created : <a
                                        href="javscript:void(0);"><span>[Cork Admin
                                            Template]</span></a></h5>
                            </div>
                            <p>27 Feb, 2020</p>
                        </div>
                    ...
                    <div class="item-timeline timeline-new">
                        ...
                        <div class="t-content">
                            <div class="t-uppercontent">
                                <h5>Mail sent to <a
                                        href="javascript:void(0);">HR</a> and <a
