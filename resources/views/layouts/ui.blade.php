...
<meta charset="utf-8">
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('vjr/assets/img/favicon.ico')}}" />
    <link href="{{asset('vjr/assets/css/loader.css')}}" rel="stylesheet" type="text/css" />
    <script src="{{asset('vjr/assets/js/loader.js')}}"></script>

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&display=swap" rel="stylesheet">
    <link href="{{asset('vjr/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
            ...
            <ul class="menu-categories">
                    ...
                    <li class="menu">
                        <a href="#uiKit" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <img src="{{asset('vjr/assets/img/code.png')}}" width="29px">
                                </div>
                                <span>Codes</span>
                            </div>
                        </a>
                    ...
                    <li class="menu">
                        <a href="#tables" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <img src="{{asset('vjr/assets/img/options.png')}}" width="29px">
                                </div>
                                <span>Options</span>
                            </div>
                        </a>
                    ...
                    <li class="menu">
                        <a href="#pages" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <img src="{{asset('vjr/assets/img/book.png')}}" width="29px">
                                </div>
                                <span>Archives</span>
                            </div>
                        </a>
                    ...
                    <li class="menu">
                        <a href="#more" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <img src="{{asset('vjr/assets/img/log-out.png')}}" width="29px">
                                </div>
                                        ...
                                        <div class="nav-item dropdown language-dropdown more-dropdown">
                                            <div class="dropdown custom-dropdown-icon">
                                                <a class="dropdown-toggle btn" href="#" role="button"
                                                    ...
                                                    aria-expanded="false"><img src="{{asset('vjr/assets/img/flag-fr3.svg')}}"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right"
                                                    ...
                                                    <a class="dropdown-item" data-img-value="flag-de3"
                                                        data-value="German" href="javascript:void(0);"><img
                                                            src="{{asset('vjr/assets/img/flag-de3.svg')}}" class="flag-width" alt="flag">
                                                        Arabe</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="activity-section">
                                            ...
                                            <div class="widget-profile">
                                                ...
                                                <div class="w-profile-view">
                                                    <img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="admin-profile"
                                                        class="img-fluid">
                                            ...
                                            <div class="widget-message">
                                                ...
                                                <div class="widget-messages">
                                                    <a href="apps_chat.html" class="w-message">
                                                        <img src="{{asset('vjr/assets/img/90x90.jpg')}}" alt="" class="img-fluid">
