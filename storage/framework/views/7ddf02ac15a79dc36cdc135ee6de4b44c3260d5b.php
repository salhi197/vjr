            ...
            <div class="card-body">
                    <form class="login100-form validate-form" method="POST" action="<?php echo e(route('reglement.store')); ?>">
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                <label>Titre *</label>
                                <input type="text" class="form-control" name="titre" id="titre" placeholder="loi..." required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Date *</label>
                                <input type="date" class="form-control" name="ladate" id="date" placeholder="Password" required>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label>Type de texte *</label>
                            <select id="selectpicker" name="type" class="form-control" data-live-search="true" required> 
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" name="secteur" class="form-control" data-live-search="true"> 
                                    <option selected>Choisir...</option>
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" name="organisme" class="form-control" data-live-search="true"> 
                                    <option selected>Choisir...</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="selectpicker" name="sous_organisme" class="form-control" data-live-search="true"> 
                                    <option selected>Choisir...</option>
