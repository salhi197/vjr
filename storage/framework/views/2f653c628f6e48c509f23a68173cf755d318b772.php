        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <ul class="menu-categories">
                    <li class="menu menu menu-single">
                        <a href="<?php echo e(route('admin')); ?>" data-active="<?php echo e(Route::is('admin') ? 'true' : ''); ?>"  class="menu-toggle">
                            <div class="base-menu">
                    ...
                    <li class="menu menu-single">
                        <a data-active="<?php echo e(Route::is('reglement.index') ? 'true' : ''); ?>" href="<?php echo e(route('reglement.index')); ?>" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                    ...
                    <li class="menu menu-single">
                        <a href="<?php echo e(route('user.index')); ?>"  data-active="<?php echo e(Route::is('user.index') ? 'true' : ''); ?>"  class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                    ...
                    <li class="menu menu-single">
                        <a href="<?php echo e(route('forum')); ?>" data-active="<?php echo e(Route::is('forum') ? 'true' : ''); ?>" class="menu-toggle">
                    ...
                    <li class="menu menu-single">
                        <a href="<?php echo e(route('rapport')); ?>" data-active="<?php echo e(Route::is('rapport') ? 'true' : ''); ?>" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                ...
                <div class="submenu" id="dashboard">
                    <ul class="submenu-list menu-block-submenu" data-parent-element="#dashboard">
                        <li class="active menu-block">
                            <a href="<?php echo e(route('admin')); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
