						...
						<div class="wrap-login100 p-6">
                            <form class="login100-form validate-form" method="POST" action="<?php echo e(route('register')); ?>" aria-label="Login">
								...
								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                                    ...
                                    <input id="naissance"  type="date" class="form-control" value="<?php echo e(old('naissance')); ?>" name="naissance"  required >
								</div>

                                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                                    <label>lieu de naissance : </label>
                                    <input id="lieu"  type="text" class="form-control" value="<?php echo e(old('lieu')); ?>" name="lieu"  required >
								</div>
