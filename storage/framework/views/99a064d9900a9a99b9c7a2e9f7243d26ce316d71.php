    ...
    <link href="<?php echo e(asset('vjr/plugins/apex/apexcharts.css')); ?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vjr/assets/css/widgets/modules-widgets.css')); ?>">
    ...
    <div class="widget widget-card-four">
        <div class="widget-content">
            ...
            <div class="w-content">
                ...
                <div class="w-info">
                    <p class="value">$ 45,141 <span>this week</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="feather feather-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></p>
                </div>
            ...
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th>
                                <div class="th-content">Customers</div>
                            </th>
                            <th>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="avatar"><span>Irene Collins</span></div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="td-content"><span class="badge outline-badge-info">Paid</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="avatar"><span>Andy King</span></div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="td-content"><span class="badge outline-badge-dark">Shipped</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="avatar"><span>Laurie Fox</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="avatar"><span>Luke Ivory</span></div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="td-content customer-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="avatar"><span>Ryan Collins</span></div>
                            </td>
                            <td>
            ...
            <div class="table-responsive">
                <table class="table table-scroll">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="td-content product-name"><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="product">
    ...
    <div class="widget widget-account-invoice-three">
        ...
        <div class="widget-heading">
            <div class="wallet-usr-info">
                <div class="usr-name">
                    <span><img src="<?php echo e(asset('vjr/assets/img/90x90.jpg')); ?>" alt="admin-profile" class="img-fluid"> Alan Green</span>
                </div>
                <div class="add">
...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script src="<?php echo e(asset('vjr/assets/js/widgets/modules-widgets.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
